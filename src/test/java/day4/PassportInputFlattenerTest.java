...
public class PassportInputFlattenerTest {

    private PassportInputFlattener passportInputFlattener;

    @Before
    public void setUp() throws Exception {
        passportInputFlattener = new PassportInputFlattener();
    }

    @Test
    public void testCaseOne() {
        final List<String> inputs = Arrays.asList("ecl:gry pid:860033327 eyr:2020 hcl:#fffffd", "byr:1937 iyr:2017 cid:147 hgt:183cm");
        final List<List<String>> flatten = passportInputFlattener.flatten(inputs);
    ...
    public void testWithTestInputs() {
        ...
        final List<List<String>> flatten = passportInputFlattener.flatten(d4_test_input);
